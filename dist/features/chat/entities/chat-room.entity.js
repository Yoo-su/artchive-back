...
__decorate([
    (0, typeorm_1.ManyToOne)(() => used_book_post_entity_1.UsedBookPost, (post) => post.chatRooms),
    __metadata("design:type", used_book_post_entity_1.UsedBookPost)
], ChatRoom.prototype, "usedBookPost", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => chat_participant_entity_1.ChatParticipant, (participant) => participant.chatRoom),
